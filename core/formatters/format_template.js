...
module.exports = function format_template({ relativePaths, formats, template, formatReplace, templateReplace }) {
  ...
  for (var formatKey in formats) {
    ...
    var formatSet = format_paths({ relativePaths, format, formatReplace, formatKey });
